...
app.get('/getPins',  function(req, res){
	pins.initialize(res, req.query.latitude, req.query.longitude, req.query.maxdistance, req.query.page, mongodb, ObjectID);
});
...
MongoClient.connect('mongodb://127.0.0.1:27017/test', function(err, db) {
	...
	mongodb = db;
	mongodb.collection('pins').ensureIndex({coordinates:'2d'}, function(err){
		if(err) {
			throw err;
		}
		console.log("Ensure Index 2d ");
	});
